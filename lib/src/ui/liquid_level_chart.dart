...
class _LiquidLevelChartState<T> extends State<LiquidLevelChart<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    final screenWidth =
        resolvedTheme.containerWidth ?? MediaQuery.of(context).size.width;
    final graphAreaWidth = screenWidth * .8;
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: List.generate(widget.data.length, (index) {
                    ...
                    double scaleMax = maxValue == 0 ? 1 : maxValue.toDouble();

                    double proportionFilled = value / scaleMax;
                    double filledHeight =
                        proportionFilled * (resolvedTheme.containerHeight - 15);
